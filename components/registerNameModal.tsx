...
export default function RegisterNameModal({ ergoname }: RegisterNameModalProps) {
    ...
    return (
        <div className="pt-36">
            <h1 className="text-white text-3xl font-bold text-center"><span className="text-blue-700">{ ergoname }</span> is available to register!</h1>
            <h1 className="text-white text-2xl font-bold text-center pt-4">1 ERG to register</h1>
            <div className="w-[25%] mx-auto pt-8">
                <button onClick={registerErgoname} className="rounded-md w-full mx-auto text-white bg-blue-700 border-2 border-white px-2 py-1 text-xl font-bold">Register Ergoname</button>
            </div>
